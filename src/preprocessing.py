...
if response_upcoming.status_code == 200:
    ...
    # Now you can proceed with data preprocessing using the 'upcoming_data' variable.
    
    # For example, you can access specific keys within 'upcoming_data' to get information about the events.
